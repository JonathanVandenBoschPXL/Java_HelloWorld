...
values ('Centrale Coherentie', @mfFunctie, 'taken tot in de puntjes uitwerken en zorgvuldig alles afmaken.', true);
SET
...
-- Mentale functies
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
values ('Centrale Coherentie', @mfFunctie, 'taken tot in de puntjes uitwerken.', false);
SET
@ccSubFunctie := last_insert_id();
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
values ('Executieve Functies', @mfFunctie, 'snel antwoorden, zonder goed na te denken.', false);
...
@efSubFunctie := last_insert_id();
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
values ('Theory of Mind', @mfFunctie, null, true);
SET
@tomSubFunctie := last_insert_id();
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
values ('Socio-emotionele ontwikkeling', @mfFunctie, 'gelooft alles wat men zegt.', true);
SET
@socioSubFunctie := last_insert_id();
-- Sensorische functies
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
...
-- Bewegingsfunctie
insert into subfunctie(naam, functie_id, opmerking, prioriteit)
values ('Bewegingsfunctie', @bewFunctie, 'loopt stroef.', false);
SET
@bewSubFunctie := last_insert_id();
...
insert into antwoord(ingevuld, naam, subfunctie_id)
values (true, 'Timemanagement', @efSubFunctie);
insert into antwoord(ingevuld, naam, subfunctie_id)
values (false, 'Doelgericht handelen', @efSubFunctie);
insert into antwoord(ingevuld, naam, subfunctie_id)
values (true, 'Flexibiliteit', @efSubFunctie);
...
insert into traject (datum_laatst_aangepast, domein_id, kind_id, situering_id, user_id)
values ('2022-11-18', @domein_id, 1, @situering_id, 2);
...
insert into traject (datum_laatst_aangepast, domein_id, kind_id, situering_id, user_id)
values ('2022-12-08', @domein_id, 1, @situering_id, 3);
