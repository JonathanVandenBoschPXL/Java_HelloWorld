...
values ('2022-11-11', @domein_id, 2, @situering_id, 5);

-- TRAJECT 2 HULPVERLENER 2 KIND 2-------------------------------------------------------------------------------------
insert into domein (kleur, naam)
values ('geel', 'stoornissen');
SET
@domein_id := last_insert_id();
...
insert into traject (datum_laatst_aangepast, domein_id, kind_id, situering_id, user_id)
values ('2022-11-12', @domein_id, 2, @situering_id, 2);

-- ---------------------------------------------------------------------------------------------------------------------
-- TRAJECT 3 LEERKRACHT 3 KIND 2-------------------------------------------------------------------------------------
insert into domein (kleur, naam)
values ('geel', 'stoornissen');
SET
@domein_id := last_insert_id();
...
insert into traject (datum_laatst_aangepast, domein_id, kind_id, situering_id, user_id)
values ('2022-11-12', @domein_id, 2, @situering_id, 3);
